                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form action="/signin" method="POST">
                        ...
                        <p class="text-sm font-light mb-4 text-gray-500 dark:text-gray-400">
                            Don't have an account yet? <a href="/signup" class="font-medium text-prior hover:underline dark:text-primary-500">Sign Up</a>
                        </p>
                        <button type="submit" class="text-white bg-prior hover:bg-second focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Sign In</button>
                    </form>
                </div>
            </div>
        </div>
